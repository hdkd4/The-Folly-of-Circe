...
public class DiceManager : MonoBehaviour
{
    ...
    public int D2(int times_rolled)
    {
        int sum = 0;
    ...
    public int D3(int times_rolled = 0)
    {
        int sum = 0;
        for (int i = 0; i < times_rolled; i++)
        {
    ...
    public int D4(int times_rolled)
    {
        int sum = 0;
        for (int i = 0; i < times_rolled; i++)
        {
    ...
    public int D6(int times_rolled)
    {
        int sum = 0;
        for (int i = 0; i < times_rolled; i++)
        {
    ...
    public int D8(int times_rolled)
    {
        int sum = 0;
        for (int i = 0; i < times_rolled; i++)
        {
    ...
    public int D10(int times_rolled)
    {
        int sum = 0;
        for (int i = 0; i < times_rolled; i++)
        {
    ...
    public int D12(int times_rolled)
    {
        int sum = 0;
        for (int i = 0; i < times_rolled; i++)
        {
    ...
    public int D20(int times_rolled)
    {
        int sum = 0;
        for (int i = 0; i < times_rolled; i++)
        {
    ...
    public int D100(int times_rolled)
    {
        int sum = 0;
        for (int i = 0; i < times_rolled; i++)
        {
